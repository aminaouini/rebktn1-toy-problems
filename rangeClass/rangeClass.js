...
Range.prototype.size = function () {
    if( this.argsLength === 1 ) return Math.floor(this.start / 2);
    if( this.argsLength === 2 ) return Math.floor((this.end - this.start) / 2);
    else {
        var steps = [];
